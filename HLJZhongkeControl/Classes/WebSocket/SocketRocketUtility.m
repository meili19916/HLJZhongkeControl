...
NSString * const kWebSocketdidSendMessageErrorNote = @"kWebSocketdidSendMessageErrorNote";
...
- (void)sendData:(id)data {
    ...
    if (self.socket == nil) {
        [[NSNotificationCenter defaultCenter] postNotificationName:kWebSocketdidSendMessageErrorNote object:nil];
    }
    WeakSelf(ws);
...
//    [self initHeartBeat];
    if (webSocket == self.socket) {
        NSLog(@"************************** socket 连接成功************************** ");
        [[NSNotificationCenter defaultCenter] postNotificationName:kWebSocketDidOpenNote object:self];
    }
}
...
- (void)webSocket:(SRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean {
    if (webSocket == self.socket) {
        ...
        [self SRWebSocketClose];
        [[NSNotificationCenter defaultCenter] postNotificationName:kWebSocketDidCloseNote object:self];
    }
}
...
- (void)webSocket:(SRWebSocket *)webSocket didReceiveMessage:(id)message  {
    ...
    if (webSocket == self.socket) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:kWebSocketdidReceiveMessageNote object:@{@"message":message,@"socket":self}];
    }
}
